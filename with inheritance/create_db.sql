...
ADD CONSTRAINT PK_instructor PRIMARY KEY (person_id);
...
CREATE TABLE level (level_id SERIAL NOT NULL, level VARCHAR(100));
ALTER TABLE level
...
ALTER TABLE student
ADD CONSTRAINT PK_student PRIMARY KEY (person_id);
...
ADD CONSTRAINT PK_additional_contact_person PRIMARY KEY (person_id_student);
...
ADD CONSTRAINT PK_instructor_instrument PRIMARY KEY (instrument_id, person_id_instructor);
...
ADD CONSTRAINT PK_sibling_relationship PRIMARY KEY (
...
ADD CONSTRAINT PK_student_ensemble PRIMARY KEY (ensemble_id, person_id_student);
CREATE TABLE student_group_lesson (
    group_lesson_id INT NOT NULL,
    person_id_student INT NOT NULL
);
ALTER TABLE student_group_lesson
ADD CONSTRAINT PK_student_group_lesson PRIMARY KEY (group_lesson_id, person_id_student);
ALTER TABLE additional_contact_person
ADD CONSTRAINT FK_additional_contact_person_0 FOREIGN KEY (person_id_student) REFERENCES student (person_id);
ALTER TABLE ensemble
ADD CONSTRAINT FK_ensemble_0 FOREIGN KEY (person_id_instructor) REFERENCES instructor (person_id);
ALTER TABLE ensemble
...
ALTER TABLE group_lesson
ADD CONSTRAINT FK_group_lesson_0 FOREIGN KEY (person_id_instructor) REFERENCES instructor (person_id);
ALTER TABLE group_lesson
...
ALTER TABLE individual_lesson
ADD CONSTRAINT FK_individual_lesson_0 FOREIGN KEY (person_id_instructor) REFERENCES instructor (person_id);
ALTER TABLE individual_lesson
ADD CONSTRAINT FK_individual_lesson_1 FOREIGN KEY (person_id_student) REFERENCES student (person_id);
ALTER TABLE individual_lesson
...
ALTER TABLE rental_agreement
ADD CONSTRAINT FK_rental_agreement_0 FOREIGN KEY (person_id_student) REFERENCES student (person_id);
ALTER TABLE rental_agreement
ADD CONSTRAINT FK_rental_agreement_1 FOREIGN KEY (rental_instrument_id) REFERENCES rental_instrument (rental_instrument_id);
ALTER TABLE sibling_relationship
ADD CONSTRAINT FK_sibling_relationship_0 FOREIGN KEY (first_person_id_student) REFERENCES student (person_id);
ALTER TABLE sibling_relationship
