...
insert into rental_instrument (instrument, brand, category)
values ('Guitar', 'Chevrolet', 'String');
insert into rental_instrument (instrument, brand, category)
values ('Piano', 'Steinway', 'String');
insert into rental_instrument (instrument, brand, category)
values ('Violin', 'Pontiac', 'String');
insert into rental_instrument (instrument, brand, category)
values ('Base', 'Toyota', 'String');
insert into rental_instrument (instrument, brand, category)
values ('Harp', 'Subaru', 'String');
insert into rental_instrument (instrument, brand, category)
values ('Flute', 'Mazda', 'Wind');
insert into rental_instrument (instrument, brand, category)
values ('Saxophone', 'Mercury', 'Wind');
insert into rental_instrument (instrument, brand, category)
values ('Trumpet', 'Ford', 'Wind');
insert into rental_instrument (instrument, brand, category)
values ('Triangle', 'Lincoln', 'Percussion');
insert into rental_instrument (instrument, brand, category)
values ('Tambourine', 'Chevrolet', 'Percussion');
insert into compensation_schema (
        base_compensation,
        individual_lesson_quanitifier,
        group_lesson_quantifier,
        ensemble_quantifier,
        beginner_quantifier,
        intermediate_quantifier,
        advanced_quantifier
    )
values (25, 1.25, 1, 0.25, 1, 2, 3);
insert into pricing_schema (
        base_price,
        individual_lesson_quanitifier,
        group_lesson_quantifier,
        ensemble_quantifier,
...
insert into instrument_fee (rental_instrument_id, fee, starting_from)
values (
        (
            SELECT rental_instrument_id
...
insert into ensemble_instrument(ensemble_id, instrument_id)
values (
        (
            SELECT ensemble_id
            FROM ensemble
